...
if __name__ == "__main__":
    dataPath = "datasets/"
    with open(dataPath + 'DIN-SQL.csv') as f:
    ...
    for approach in approaches:
        ...
        with jsonlines.open(dataPath + f'{approach.__name__}_train_dataset.jsonl', mode='w') as writer:
            writer.write_all(train_dataset)

    for approach in approaches:
        test_dataset = approach.build_test_dataset(test_data)
        with jsonlines.open(dataPath + f'{approach.__name__}_test_dataset.jsonl', mode='w') as writer:
